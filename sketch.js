...
if(gameState=="intro"){
   ...
   textSize(100);
   stroke("yellow");
   text("WELCOME TO MY GAME",150,100);

   textSize(30);
   fill("red");
   text("designed by Shreya Sudarshan and Sneha Malik(teacher)",300,150)

   fill("white");
   text("1. press space to jump",300,200);
   textSize(50);
   text("PRESS ENTER TO PLAY",400,600);
